...
import com.easybytes.easyschool.handler.CustomAuthenticationFailureHandler;
import com.easybytes.easyschool.handler.CustomAuthenticationSuccessHandler;
...
public class ProjectSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user = User.withUsername("user")
                .password("{noop}EasyBytes@12345").authorities("read").build();
        UserDetails admin = User.withUsername("admin")
                .password("{bcrypt}$2a$12$y8mmMcvrMd.A4oeUrrewUezV9ZPuBaUFT9W.L6rzMWKuU33oGX30K")
